...
return [
    'providers' => [
        ...
        App\Services\Calendar\Providers\SubProvider::class        => ['level' => 4, 'type' => EventType::ON,         'plan' => PlanGroup::REGULAR_PLAN], // プロトタイプはOnline校のAdjustment Day
      ...
      //App\Services\Calendar\Providers\SubProvider::class        => ['level' => 2, 'type' => EventType::ON,         'plan' => PlanGroup::EVENT],         // 出勤後上書き、非出勤はNS対応
    ],
