// 交通費入力スプレッドシートの編集・バリデーション・API保存を制御するスクリプト
(function () {
  'use strict';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    topScroll.className = 'expense-edit-top-scroll';
    const topScrollInner = document.createElement('div');
    topScrollInner.className = 'expense-edit-top-scroll-inner';
    ...
    function enableSelectionAutoScroll(wrapper, targetEl) {
    ...
    enableSelectionAutoScroll(scrollWrapper, sheetEl);
