...
class CompanyClosureSeeder extends Seeder
{
    public function run(): void
    {
        CompanyClosure::updateOrCreate(
            ['code' => 'GW', 'start_date' => '2026-04-29'],
            ['name' => 'Golden Week', 'end_date' => '2026-05-06', 'is_active' => true]
        );
        CompanyClosure::updateOrCreate(
            ['code' => 'SB', 'start_date' => '2026-08-05'],
            ['name' => 'Summer Break', 'end_date' => '2026-08-16', 'is_active' => true]
        );
        CompanyClosure::updateOrCreate(
